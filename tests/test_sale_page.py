import pytest
import allure
from pages.helper.text_to_check import MAIN_SALE_WOMAN_INFO, \
...
class TestSalePage:
    ...
    def test_all_sales_blocks_are_displayed(self, pw_sales_page):
    ...
    def test_main_sales_card_ui(self, pw_sales_page):
        with allure.step("Open the Sales Page"):
            pw_sales_page.open_by_url()
    ...
    @allure.severity(allure.severity_level.CRITICAL)
    def test_open_main_sale_screen_via_clicking_on_button(self, pw_sales_page, pw_women_sale_page):
